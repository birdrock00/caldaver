...
$translations = array(
    ...
    'labels.refresh_interval_minutes' => 'Auto refresh minutes',
    'labels.mark_unread' => 'Mark unread',
    'labels.addaccount' => 'Add account',
    'labels.accountname' => 'Account name',
    'labels.emailaddress' => 'Email address',
    'labels.imaphost' => 'IMAP host',
    'labels.imapport' => 'IMAP port',
    'labels.encryption' => 'Encryption',
    'labels.inbox' => 'Inbox',
    'labels.noaccounts' => 'Add an IMAP account to download mail.',
    'labels.nomessages' => 'Checking the IMAP server for mail...',
...
// Messages
    ...
    'messages.info_reminders_caldaver_support' => 'Note: notifications will only be shown by compatible CalDAV clients. Caldaver cannot show them',
