...
// Messages
    ...
    'messages.info_reminders_caldaver_support' => 'Примечание: уведомления будут отображаться только в клиентах с поддержкой CalDAV . Caldaver не может отобразить их',
