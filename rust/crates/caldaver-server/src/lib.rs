...
mod tests {
    ...
    async fn rendered_mail_reader_keeps_back_and_unread_controls() {
        ...
        assert!(html.contains(r#"id="mail_reader_newer""#));
        assert!(html.contains(r#"id="mail_reader_older""#));
        assert!(html.contains(r#"class="mail-reader-nav""#));
