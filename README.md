...
[![Build Status](https://github.com/birdrock00/caldaver/actions/workflows/ci.yml/badge.svg)](https://github.com/birdrock00/caldaver/actions)
[![Made With](https://img.shields.io/badge/made_with-php-blue)](https://github.com/birdrock00/caldaver#requirements)
...
docker run -d --name caldaver \
  ...
  -e CALDAVER_CSRF_SECRET=<SET_ME> rand -hex 32)" \
