...
class SharingResolverTest extends TestCase
{
    ...
    {
        $shares_repository = $this->createMock(\Caldaver\Repositories\SharesRepository::class);
        $principals_repository = $this->createMock(\Caldaver\Repositories\PrincipalsRepository::class);
