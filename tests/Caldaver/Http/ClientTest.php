...
class ClientTest extends TestCase
{
    ...
    {
        $this->expectException(\Caldaver\Exception\NotAuthenticated::class);
        $client = $this->createClient([
            new Response(401)
        ]);
    ...
    {
        $this->expectException(\Caldaver\Exception\PermissionDenied::class);
        $client = $this->createClient([
            new Response(403)
        ]);
    ...
    {
        $this->expectException(\Caldaver\Exception\ElementModified::class);
        $client = $this->createClient([
            new Response(412)
        ]);
